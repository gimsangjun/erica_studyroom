...
-- 팀플실 : 국제문학대학
INSERT INTO study_room(name, university, building, location, capacity)
VALUES ('IC-PBL 꿈의 둥지(OPEN SPACE)', '국제문학대학', '국제문화관', '1층', 4),
       ('122호 IC-PBL 강의실', '국제문학대학', '국제문화관', '1층', 4),
       ('201호 강의실', '국제문학대학', '국제문화관', '2층', 6),
       ('202호 강의실', '국제문학대학', '국제문화관', '2층', 6),
       ('304호 강의실', '국제문학대학', '국제문화관', '3층', 10),
       ('305호 강의실', '국제문학대학', '국제문화관', '3층', 10);

-- 팀플실 : 언론정보대학
INSERT INTO study_room(name, university, building, location, capacity)
VALUES ('114호 교양강의실 1', '국제문학대학', '언론정보관', '지하1층', 4),
       ('115호 교양강의실 2', '국제문학대학', '언론정보관', '지하1층', 4),
       ('ALC 1', '국제문학대학', '언론정보관', '1층', 4),
       ('ALC 2', '국제문학대학', '언론정보관', '1층', 4),
       ('스마트교육강의실', '국제문학대학', '언론정보관', '1층', 6),
       ('202호 IC-PBL 강의실', '국제문학대학', '언론정보관', '2층', 6),
       ('209호 IC-PBL 세미나실', '국제문학대학', '언론정보관', '2층', 10),
       ('오디오스튜디오', '국제문학대학', '언론정보관', '2층', 10), -- (오디오스튜디오)
       ('비디오스튜디오', '국제문학대학', '언론정보관', '2층', 10); -- (비디오스튜디오)
